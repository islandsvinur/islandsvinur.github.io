---
layout: post
title: "One Europe: Let's start with the railroads"
date: 2007-07-08 23:32:59 +0200
---

"!(right)/image/rants.gif!":/tags/rants/ A great idea this week by the high
speed train operators Eurostar, Deutsche Bahn, SNCF, SNCB, NS Hispeed,
&Ouml;BB, SBB and Thalys, Lyria and Alleo; they're going to create a single
...
an "ICE Sprinter":http://de.wikipedia.org/wiki/ICE_Sprinter, which is an
extra fast "InterCityExpress":http://de.wikipedia.org/wiki/InterCityExpress
train that halts only on a few stations on the line, thereby winning time.
French long-distance TGVs do this by default.

Ironically (?),
"Sprinters":http://nl.wikipedia.org/wiki/Stadsgewestelijk_Materieel are the
...
Spoorwegen":http://www.ns.nl/ - replacing the clear but rather dull name
"Stoptrein":http://nl.wikipedia.org/wiki/Stoptrein. Now, I don't know how
